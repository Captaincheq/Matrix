...
const char* ssid = "us";                   // edit your wifi SSID here
const char* password = "qwertyuiop";            // edit your wifi password here
...
"</head>" \
"<body>" \
"<H1><b>What will you do after graduation?</b></H1>" \ 
...
"</form>" \
"<br>" \
"<input type=\"submit\" value=\"Transmit\" onclick=\"SendText()\">" \
"</div>" \
"</body>" \
"</html>";
